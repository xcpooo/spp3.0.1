...
int ExampleMsg::HandleProcess()
{
    ...
    int ret = mt_udpsendrcv(&dst, (void*)_msg_buff.data(), (int)_msg_buff.size(), buf, buf_size, 100);
    if (ret < 0)
    {
